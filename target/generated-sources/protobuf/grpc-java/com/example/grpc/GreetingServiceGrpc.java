...
public final class GreetingServiceGrpc {
  ...
  public static final io.grpc.MethodDescriptor<com.example.grpc.MyRequest,
      com.example.grpc.MyResponse> METHOD_GET_CUR_NAME =
      io.grpc.MethodDescriptor.<com.example.grpc.MyRequest, com.example.grpc.MyResponse>newBuilder()
          .setType(io.grpc.MethodDescriptor.MethodType.UNARY)
          .setFullMethodName(generateFullMethodName(
              "com.example.grpc.GreetingService", "getCurName"))
  ...
  public static abstract class GreetingServiceImplBase implements io.grpc.BindableService {
    ...
    /**
     */
    public void getCurName(com.example.grpc.MyRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.MyResponse> responseObserver) {
      asyncUnimplementedUnaryCall(METHOD_GET_CUR_NAME, responseObserver);
    }
  ...
  public static final class GreetingServiceStub extends io.grpc.stub.AbstractStub<GreetingServiceStub> {
    ...
    public void getCurName(com.example.grpc.MyRequest request,
        io.grpc.stub.StreamObserver<com.example.grpc.MyResponse> responseObserver) {
      asyncUnaryCall(
          getChannel().newCall(METHOD_GET_CUR_NAME, getCallOptions()), request, responseObserver);
    }
  }
  ...
  public static final class GreetingServiceBlockingStub extends io.grpc.stub.AbstractStub<GreetingServiceBlockingStub> {
    ...
    /**
     */
    public com.example.grpc.MyResponse getCurName(com.example.grpc.MyRequest request) {
      return blockingUnaryCall(
          getChannel(), METHOD_GET_CUR_NAME, getCallOptions(), request);
    }
  }
  ...
  public static final class GreetingServiceFutureStub extends io.grpc.stub.AbstractStub<GreetingServiceFutureStub> {
    ...
    /**
     */
    public com.google.common.util.concurrent.ListenableFuture<com.example.grpc.MyResponse> getCurName(
        com.example.grpc.MyRequest request) {
      return futureUnaryCall(
          getChannel().newCall(METHOD_GET_CUR_NAME, getCallOptions()), request);
    }
  }

  private static final int METHODID_GET_CUR_NAME = 0;
  ...
  private static final class MethodHandlers<Req, Resp> implements
    ...
    public void invoke(Req request, io.grpc.stub.StreamObserver<Resp> responseObserver) {
      switch (methodId) {
        case METHODID_GET_CUR_NAME:
          serviceImpl.getCurName((com.example.grpc.MyRequest) request,
              (io.grpc.stub.StreamObserver<com.example.grpc.MyResponse>) responseObserver);
          break;
        default:
  ...
  private static final class GreetingServiceDescriptorSupplier implements io.grpc.protobuf.ProtoFileDescriptorSupplier {
    ...
    public com.google.protobuf.Descriptors.FileDescriptor getFileDescriptor() {
      return com.example.grpc.MyService.getDescriptor();
    }
  }
